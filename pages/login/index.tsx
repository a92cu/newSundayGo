    ...
    const handleClick = () => {
        fetch(`http://localhost:3000/api/login/${props.userId}`, {
            ...
            .then(data => {
                ...
                console.log("使用者資料",data.data[0].userId);
                console.log("使用者資料",data.data[0].userPassword);
                                        ...
                                        <div id="login" className="loginTabContent">
                                            ...
                                            <div>
                                                <form action="">
                                                    ...
                                                    <input id="" value={userId} type="text" placeholder="請輸入帳號"  /><br />
                                                    <label htmlFor="">密碼</label>
                                                    <input type="password" placeholder="請輸入密碼" /><br />
                                                    <input type="submit" value="確認" onClick={() => handleClick()} />
