    ...
    case 'GET':
      ...
      case "POST":
        try {
          ...
          const sq2 = `selct * from fov where for.userId='u123456789' `;
          let data=runSQL(sq2);
          // data.forEach(element => {
          //   if(req.body.itemId!==element.itemId){
        ...
        //     const sq1 = `UPDATE favorite SET userId='u123456789' , itemId = ${req.body.itemId}) where favId=10 `;
        //     // const sq1 = `INSERT INTO favorite  VALUES (5,'u123456789',30)`;
        //     runSQL(sq1);
        //     res.status(200).json({ message: "ok" });
        //   } catch (error) {
