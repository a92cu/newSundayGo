    ...
    useEffect(() => {
        ...
        a.forEach(el => {
            el.addEventListener("mouseenter", function (e) {
                ...
                //   console.log(result)    
                $(".item1,.item2,.item3").text(result[0].place)
                // $(".item1").text(result[0].place)
                $(".t1").text(result[0].itemname)
                $(".t2").text(result[0].itemname2)
                $(".t3").text(result[0].itemname3)
                // $(".homecontainer").append(`<img src="${result[0].img}">`)
                // $(".mapimg1").attr('src', `${try1[0][0].itemImgUrl}`)
                $(".mapimg1").attr('src', `${result[0].img}`);
                $(".mapimg2").attr('src', `${result[0].img2}`);
                $(".mapimg3").attr('src', `${result[0].img3}`);
        ...
        async function fetchdata() {
            return (await axios("/api/home/homepageimg")
                // .then((res) => res.json())
                .then((result) => {
                    ...
                    // 圖片
                    // console.log(2, result.data.data[0].itemImgUrl)
                    ...
                    // console.log(3, try1)
                    // console.log(3, try1[0][0].itemImgUrl)
                })
            )
        };

        // console.log(3,result.data[0].itemImgUrl)
        // console.log(4,try1[0][0].itemImgUrl)
        // [0][0].itemImgUrl            
        var place_data = [
            {
                tag: "taipei_city",
                place: "臺北市",
                itemname: "台北六福萬怡酒店敘日餐廳自助式午或晚餐券",
                itemname2: "國立故宮博物院門票成人票",
                itemname3: "精緻客房一大床｜不含早餐｜提供王朝港點套餐｜入住日晚餐使用",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_28828/20220118032217_LJVbr/jpg",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_101875/20200724065807_jT7L6/jpg",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_116636/20210316080728_p9fEI/jpg"
                // img: URL("./_img/test1.jpg")
            ...
            },
            {
                ...
                place: "新北市",
                itemname: "單人品茗體驗",
                itemname2: "滿月圓國家森林遊樂區門票成人票",
                itemname3: "庭園高級雙人房",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_8189/20161021032150_fLYWu/jpg",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_100554/20200528092356_cxC9b/jpg",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_118196/20210409055043_fjwM2/jpg"

            },
            {
                tag: "taichung_city",
                place: "台中市",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_128192/20220416123223_KrCpD/jpg",
                itemname: "台中大毅老爺行旅住宿券",
                img2: "https://image.kkday.com/v2/image/get/w_481%2Ch_358%2Cc_fill%2Cq_55%2Ct_webp/s1.kkday.com/product_23729/20220111015504_KybkW/jpg",
                itemname2: " 台中金典酒店餐券",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_121622/20210810073425_hLVS7/jpg",
                itemname3: "台中大坑紙箱王創意園區票券 "
            },
            {
                tag: "tainan_city",
                place: "臺南市",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_100025/20210423113719_FLdJK/jpg",
                itemname: " 頑皮世界野生動物園門票券",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_21264/20210217074116_3XOtH/jpg",
                itemname2: "台南十鼓仁糖文創園區票券 ",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_128591/20220425042434_xs9Oj/jpg",
                itemname3: "安平定情碼頭德陽艦園區票券 "
            },
            {
                tag: "kaohsiung_city",
                place: "高雄市",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_134707/20221020082521_ZJGNt/jpg",
                itemname: "飲料兌換券",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_129556/20220518035137_8YVjv/jpg",
                itemname2: " 和逸飯店‧高雄中山館 Cozzi THE Roof 單人下午茶套餐券",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_100527/20200529074002_SNYYK/jpg",
                itemname3: "寒軒國際大飯店住宿雙人房住宿券"
            },
            {
                tag: "keelung_city",
                place: "基隆市",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_23472/20190425045559_H101R/jpg",
                itemname: "和平島公園電子門票",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_126847/20220222092656_gD1WY/png",
                itemname2: "當日租還優惠",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_127033/20220331090947_9u3NN/jpg",
                itemname3: "潮境智能海洋館門票全票"
            },
            {
                tag: "taoyuan_country",
                place: "桃園市",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_100557/20200528103309_j2ywg/jpg",
                itemname: "東眼山國家森林遊樂區門票成人票",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_129447/20220517145024_qRO0k/jpg",
                itemname2: "雙人下午茶套餐券",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_135269/20221102031227_0MhOT/jpg",
                itemname3: "豪華雙人房一大床"
            },
            {
                tag: "hsinchu_city",
                place: "新竹市",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_125748/20220103071938_8TSLy/png",
                itemname: "新竹尖石溫泉標準湯屋住宿券",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_6370/20220825082844_0RZJ4/jpg",
                itemname2: "六福村主題遊樂園四人套票",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_23741/20210205021022_6S7c8/jpg",
                itemname3: "新竹老爺酒店餐券"
            },
            {
                tag: "hsinchu_country",
                place: "新竹縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_101861/20200724030239_hmkn4/jpg",
                itemname: "青蛙石天空步道門票全票",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_128176/20220401054425_MIMYe/jpg",
                itemname2: "新竹市立動物園門票成人票",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_122460/20210820044401_CRylD/jpg",
                itemname3: "168 motel 3 小時雙人房休息"
            },
            {
                tag: "miaoli_country",
                place: "苗栗縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_122762/20210903101144_yqzkr/jpg",
                itemname: "巴巴坑道休閒礦場門票全票",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_128162/20220330061146_BJ3PW/jpg",
                itemname2: "假日下午茶套餐券",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_34005/20191120093944_aDyRw/jpg",
                itemname3: "苗栗尚順育樂世界門票全票"
            },
            {
                tag: "changhua_country",
                place: "彰化縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_119292/20221017034824_ZKcOW/jpg",
                itemname: "成美文化園門票全票",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_131511/20220725063723_vmLbM/jpg",
                itemname2: "高級雙人房一大床|贈卷木森活館入場門票 2 張",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_116315/20210903082804_1G5Pj/jpg",
                itemname3: "彰化百果山探索樂園門票全票"

            },
            {
                tag: "nantou_country",
                place: "南投縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_101587/20220609112551_Q7Xog/jpg",
                itemname: "銀杏樓雙人房住宿券",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_102722/20201103041138_PQCLN/jpg",
                itemname2: "東方餐廳 The Oriental Brasserie 餐券",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_114053/20201208082138_GFT3c/jpg",
                itemname3: "清境小瑞士花園門票全票"
            },
            {
                tag: "yunlin_country",
                place: "雲林縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_32341/20191016112122_NDArl/jpg",
                itemname: "劍湖山世界主題樂園門票全票",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_126349/20220125032349_B0sxM/jpg",
                itemname2: "雲林劍湖山渡假大飯店雙人房",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_103382/20200910064319_lfRyf/jpg",
                itemname3: "平日御品汽車雙人房住宿券"
            },
            {
                tag: "chiayi_city",
                place: "嘉義市",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_30368/20190926041640_mi1oi/jpg",
                itemname: "沙鍋魚肉、雞肉飯/滷肉飯、阿里山冷泡茶套餐",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_28087/20190902035539_101vg/jpg",
                itemname2: "雞肉飯全餐",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_102051/20200804080441_joc9R/png",
                itemname3: "嘉義大學組合套票"
            },
            {
                tag: "chiayi_country",
                place: "嘉義縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_131137/20220713015036_G8zqo/jpg",
                itemname: "積木館｜豪華四人房",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_102359/20200810024507_wrlwT/png",
                itemname2: "太平雲梯門票",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_114010/20201207081646_mMRPr/jpg",
                itemname3: "板陶窯入園門票"
            },
            {
                tag: "pingtung_country",
                place: "屏東縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_129507/20220517052323_5Gdi3/jpg",
                itemname: "墾丁長灘休閒飯店住宿雙人房住宿券",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_9468/20190225091057_q1e4v/jpg",
                itemname2: "屏東海生館門票 ",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_13338/20171108080341_Zx2xp/jpg",
                itemname3: "墾丁漆彈生存戰活動"
            ...
            },
            {
                tag: "yilan_country",
                place: "宜蘭縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_31476/20201118034424_gLf27/jpg",
                itemname: "寒沐酒店餐券",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_100467/20200526023453_uxMdW/png",
                itemname2: "太平山國家森林遊樂區門票 ",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_104627/20201028040608_48ryk/jpg",
                itemname3: "茶園導覽DIY體驗行程"
            },
            {
                tag: "hualien_country",
                place: "花蓮縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_102467/20200923092342_se7jx/jpg",
                itemname: "花蓮秘境生態溯溪",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_122019/20210812102656_bwTBF/jpg",
                itemname2: "美侖大飯店住宿券",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_113778/20220406095820_VPpaO/jpg",
                itemname3: "嘻餐町餐券"
            },
            {
                tag: "taitung_country",
                place: "台東縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_23638/20201030043907_e27eK/jpg",
                itemname: "台東知本老爺酒店-船歌餐廳午餐餐券",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_105727/20210407071718_4hS9P/jpg",
                itemname2: "台東野溪溫泉導覽",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_23643/20190502095524_zqzyz/jpg",
                itemname3: "台東知本老爺酒店餐券-酋長鐵板燒"
            },
            {
                tag: "penghu_country",
                place: "澎湖縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_124246/20211118075747_OYw1Q/jpg",
                itemname: "澎湖來回計畫機票",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_23286/20200720062659_kaNjA/jpg",
                itemname2: "澎湖福朋喜來登酒店餐券",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_116425/20210309034856_8EDSu/jpg",
                itemname3: "福朋喜來登酒店住宿券"
            },
            {
                tag: "kinmen_country",
                place: "金門縣",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_102949/20210218021904_lgIoD/jpg",
                itemname: "金門來回機票",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_102318/20200921061603_9zWLY/png",
                itemname2: "酒糟牛全牛火鍋餐券",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_19847/20180830072340_7hUi5/jpg",
                itemname3: "台灣好行巴士-金門各路線乘車券"
            },
            {
            ...
            },
            {
                tag: "liuqiu",
                place: "小琉球",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_102247/20221102075909_jblDd/png",
                itemname: "小琉球潛水＆水肺潛水體驗行程",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_116861/20210323034401_GRUV0/jpg",
                itemname2: "古拉克民宿｜平日雙人房主題型住宿券",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_123265/20220103075250_0CFTW/jpg",
                itemname3: "小琉球船票 "
            },
            {
                tag: "matsu",
                place: "馬祖",
                img: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_124037/20211110063617_6U3ua/png",
                itemname: "台馬之星 | 台馬輪 | 基隆往馬祖船票 (雙人床)",
                img2: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_127060/20220223011314_eVk6p/jpg",
                itemname2: "舒適雙人房 (兩小床)",
                img3: "https://image.kkday.com/v2/image/get/h_650%2Cc_fit/s1.kkday.com/product_123973/20211109063113_iizfB/jpg",
                itemname3: "南竿北海坑道獨木舟體驗"
            },
        ];
        ...
        // });
        // var sidebar2 = new StickySidebar('#sidebar2', { // 要固定的側邊欄
        //     containerSelector: '#main-content', // 側邊欄外面的區塊
        ...
        <main style={{ width: '1280px', margin: '0 auto' }}>
            ...
            <div style={{ width: '800px', zIndex: '20', display: 'inline', marginLeft: '0' }}>
                <svg width="500" height="1200" id="cf503461-00bd-459a-aeb5-062ebc913211" data-name="圖層 1" xmlns="http://www.w3.org/2000/svg" s
                    ...
                    <path id="161d6372-ac8f-409c-ad51-9db7795c8614" data-name="liuqiu"
                    ...
                    <path id="3068b8ea-2f06-4a38-a3fe-192fea39a5d2" data-name="green_island"
                        className="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                    ...
                    <path id="4f83d8a6-50fd-42c9-b927-6a9680868ba7" data-name="orchid_island"
                        className="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                    ...
                    <g id="f292dbb8-1f08-451f-af4d-83b2a6953aa2" data-name="kinmen_country">
                        <path id="b83ee7c9-49c5-43e6-acea-f06d1c113084" data-name="kinmen_country"
                            className="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                        ...
                        <path id="095a4c54-e8f5-4120-91cf-b6c705de29ff" data-name="kinmen_country"
                            className="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                        ...
                        <path id="87972721-81c8-4058-acb3-6963aa0ed3e0" data-name="path2655"
                            className="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9" d="M107.46,220l-.75.25.31.31H108l-.5-.56h0Z" />
                        <path id="1618ff3b-8feb-42b3-b000-0d7dc2b4b993" data-name="path2657"
                            className="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9" d="M111.85,244l-.38.38.88-.06-.5-.31Z" />
                    </g>
                    ...
                    <g id="13520621-f1ed-4c7b-8b5d-1a169d9bf935" data-name="g4313">
                        ...
                        <path id="167388a5-547c-4480-932a-6c0a66e1048a" data-name="matsu"
                            className="bc4bd339-f614-4405-a1f2-7f894051d5a3"
                            d="M58,91.41l.27,6.52.54-3L61,93.58l3.26-.27,2.44-1.63,1.9,2.17.54-1.36-2.44-4.07-8.69,3Z" />
                        <path id="f2323ce6-4de0-4fd5-9e90-8aa5c070854a" data-name="matsu"
                            className="bc4bd339-f614-4405-a1f2-7f894051d5a3"
                ...
                {/* <div className="forcast" v-if="now_area" style={{ float: 'left', margin: '100px auto' }}>
                    ...
                    <div className="forcast" v-if="now_area" style={{ float: 'right', margin: '100px auto' }}>
                        <img src="" alt="" />
                    </div> */}
